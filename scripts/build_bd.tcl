...
proc write_mig_file_design_1_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="" PADName="M4" SLEW="" VCCAUX_IO="" name="ddr3_cas_n"/>}
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="" PADName="P3" SLEW="" VCCAUX_IO="" name="ddr3_ras_n"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="" PADName="K6" SLEW="" VCCAUX_IO="" name="ddr3_reset_n"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="" PADName="P5" SLEW="" VCCAUX_IO="" name="ddr3_we_n"/>}
   puts $mig_prj_file {    </PinSelection>}
...
proc create_root_design { parentCell } {
  ...
  set mmcm_reset [ create_bd_port -dir I -type rst mmcm_reset ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {refclk} \
   CONFIG.CLK_OUT2_PORT {sysclk} \
  ...
  set_property USER_COMMENTS.comment_0 "sys_rst is connected to the active low red 'RESET' push button" [get_bd_cells /mig_7series_0]
  ...
  # Create port connections
  connect_bd_net -net SYS_Rst_1 [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_mig_7series_0_83M/bus_struct_reset]
  ...
  connect_bd_net -net clk_100_1 [get_bd_ports clk_100] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_refclk [get_bd_pins clk_wiz_0/refclk] [get_bd_pins mig_7series_0/clk_ref_i]
  connect_bd_net -net clk_wiz_0_sysclk [get_bd_pins clk_wiz_0/sysclk] [get_bd_pins mig_7series_0/sys_clk_i]
  ...
  connect_bd_net -net mig_7series_0_init_calib_complete [get_bd_ports calib_complete] [get_bd_pins mig_7series_0/init_calib_complete]
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins c_counter_binary_0/CE] [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins rst_mig_7series_0_83M/dcm_locked]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  ...
  connect_bd_net -net mmcm_reset_1 [get_bd_ports mmcm_reset] [get_bd_pins clk_wiz_0/reset]
  connect_bd_net -net reset_1 [get_bd_ports areset_n] [get_bd_pins mig_7series_0/sys_rst]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn1 [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports heartbeat] [get_bd_pins xlslice_0/Dout]
